...
def loadWords():
    ...
    """
    print("Instruction for making better points: ")
    print("1) Make the best possible word from the given character")
    print("2) Make sure you will get maximum point if you used them all. That means at the end you do not have any word to create new word")
    print(" ")
...
def isValidWord(word, hand, wordList):
    ...
    if set(list(word)) <= set(hand_1.keys()):       # set() watch the video this new concept
        letter_check = True
    else:
        letter_check = False
